...
`Agent Identity Service` project.
...
The `Agent Identity Service` maintainers take all security issues in the project
seriously. Thank you for improving the security of `Agent Identity Service`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`Agent Identity Service` leverages GitHub's private vulnerability reporting.
