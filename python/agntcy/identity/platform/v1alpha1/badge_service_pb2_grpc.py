...
from agntcy.identity.platform.v1alpha1 import badge_service_pb2 as agntcy_dot_identity_dot_platform_dot_v1alpha1_dot_badge__service__pb2
...
class BadgeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.IssueBadge = channel.unary_unary(
                ...
                request_serializer=agntcy_dot_identity_dot_platform_dot_v1alpha1_dot_badge__service__pb2.IssueBadgeRequest.SerializeToString,
...
def add_BadgeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'IssueBadge': grpc.unary_unary_rpc_method_handler(
                    servicer.IssueBadge,
                    request_deserializer=agntcy_dot_identity_dot_platform_dot_v1alpha1_dot_badge__service__pb2.IssueBadgeRequest.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'agntcy.identity.platform.v1alpha1.BadgeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agntcy.identity.platform.v1alpha1.BadgeService', rpc_method_handlers)
...
class BadgeService(object):
    ...
    def IssueBadge(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/agntcy.identity.platform.v1alpha1.BadgeService/IssueBadge',
            agntcy_dot_identity_dot_platform_dot_v1alpha1_dot_badge__service__pb2.IssueBadgeRequest.SerializeToString,
