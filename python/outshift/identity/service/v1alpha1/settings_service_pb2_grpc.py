...
from outshift.identity.service.v1alpha1 import settings_service_pb2 as outshift_dot_identity_dot_service_dot_v1alpha1_dot_settings__service__pb2
...
def add_SettingsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSettings': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_settings__service__pb2.GetSettingsRequest.FromString,
                    response_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_settings__pb2.Settings.SerializeToString,
            ),
            'SetApiKey': grpc.unary_unary_rpc_method_handler(
                    servicer.SetApiKey,
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_settings__service__pb2.SetApiKeyRequest.FromString,
                    response_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_settings__pb2.ApiKey.SerializeToString,
            ),
            'SetIssuer': grpc.unary_unary_rpc_method_handler(
                    servicer.SetIssuer,
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_settings__service__pb2.SetIssuerRequest.FromString,
                    response_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_settings__pb2.IssuerSettings.SerializeToString,
            ),
    }
