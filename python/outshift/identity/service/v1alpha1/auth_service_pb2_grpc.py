...
from outshift.identity.service.v1alpha1 import auth_service_pb2 as outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AppInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2.AppInfoResponse.SerializeToString,
            ),
            'Authorize': grpc.unary_unary_rpc_method_handler(
                    servicer.Authorize,
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2.AuthorizeRequest.FromString,
                    response_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2.AuthorizeResponse.SerializeToString,
            ),
            'Token': grpc.unary_unary_rpc_method_handler(
                    servicer.Token,
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2.TokenRequest.FromString,
                    response_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2.TokenResponse.SerializeToString,
            ),
            'ExtAuthz': grpc.unary_unary_rpc_method_handler(
                    servicer.ExtAuthz,
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2.ExtAuthzRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'ApproveToken': grpc.unary_unary_rpc_method_handler(
                    servicer.ApproveToken,
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_auth__service__pb2.ApproveTokenRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
    }
